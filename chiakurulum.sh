...
cd
mkdir /root/temp
git clone --recursive https://github.com/Chia-Network/bladebit.git && apt remove cmake -y && pip install cmake --upgrade && cd bladebit && sh build.sh && cd build-release && screen -dmS plot ./bladebit -n 9999 -c xch1m34zpgre2cz406neagtfjxgt6q4sffu37e9txctn2gx3ex0dw66qxzn5lz -f 8d32e1645c12df89131e03484569ff5287e09ed5a39ff5df7fb1c671eb730ae4aef20155d7babb4fd86f1eb5b8719487 ramplot /root/plot
